...
void LinearTransformations::ApplyRotation(std::shared_ptr<InputHandler> inputHandlerPtr, std::shared_ptr<Time> timePtr, std::shared_ptr<PrimitiveObject> object) { //rotates radiansToRotate/sec when corresponding input is held down
...
void LinearTransformations::ApplyTransformation(std::shared_ptr<InputHandler> inputHandlerPtr, std::shared_ptr<Time> timePtr, std::shared_ptr<PrimitiveObject> object) {
...
/*
void LinearTransformations::ApplyScaling(std::shared_ptr<InputHandler> inputHandlerPtr, PrimitiveObject& object, std::shared_ptr<Time> timePtr, float scalar) {
